...
function main() {
    ...
    //f_all.saveFile(mofi.file('sepEps'), save_ops.sepPS(), false);
    var saveFile = mofi.file('sepEps');
    if (!saveFile.parent.exists) {
        saveFolder = new Folder(saveFile.parent)
        saveFolder.create();
    };
    save_dcs2(mofi.file('sepEps'));
    ...
    if(previewType == 'Vollton') {
        ...
        f_all.saveFile(mofi.file('previewPs'), save_ops.previewPS(), false);
    } else {
        previewDoc.flatten();  
