    ...
    w.orientation = 'column';
        ...
        tablePnl.alignment = 'fill';
            ...
            for(var i=0; i < report.spotChannels.length; i+=1) {
                ...
                var areaText = areaGrp.add('statictext',undefined,(spotChan.area).toFixed(1) + ' cm²');
                areaText.preferredSize = [70,25];

                var covText = covGrp.add('statictext',undefined,((spotChan.area/ report.totalArea)*100).toFixed(0) + ' %');
                ...
                var volume = vthTab[screenDrop.selection] * spotChan.area * Number(runEdit.text);
