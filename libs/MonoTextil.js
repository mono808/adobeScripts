function MonoTextil() {
    ...
    return {
        ...
        get_tex_folder: function () {
            var texFolders = texRoot.getFiles(function (a) {
        ...
        get_tex_files: function (fld) {
            var texFiles = fld.getFiles(function (a) {
        ...
        show_type_ahead: function (array, propertyToList) {
            var names;
            if (propertyToList) {
                names = this.create_names_array(array, propertyToList);
            } else {
                names = array;
            }
            var selected = [];
            ...
            entry.onChanging = function () {
                ...
                for (var i = 0; i < names.length; i++) {
                    ...
                    if (tempArray.length > 0) {
                        ...
                        var tempList = dummy.add("listbox", list.bounds, tempArray, {
                            scrolling: true
                        });
                        dummy.remove(list);
                        list = tempList;
            ...
            if (w.show() != 2) {
                ...
                for (var j = 0; j < selected.length; j++) {
                    returnArray.push(this.get_member(array, selected[j], propertyToList));
                }
                return returnArray;
            }
            w.close();
...
exports = module.exports = MonoTextil;
