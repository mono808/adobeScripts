...
function AiSiebdruck(initDoc) {
    ...
    this.spots = [];
    this.pathItems = AiBase.prototype.get_items_on_layer.call(
        this,
        this.doc.pathItems,
        "Motiv"
    );
    this.rasterItems = AiBase.prototype.get_items_on_layer.call(
        this,
        this.doc.rasterItems,
        "Motiv"
    );
    this.pageItems = AiBase.prototype.get_items_on_layer.call(
        this,
        this.doc.pageItems,
        "Motiv"
    );
    ...
    this.sqpt2sqcm =
        new UnitValue(1, "pt").as("cm") * new UnitValue(1, "pt").as("cm");
}
...
AiSiebdruck.prototype.sort_by_spotColor = function (pIs) {
    ...
    while (i >= 0) {
        ...
        switch (fC.constructor.name) {
            ...
            case "GradientColor":
                mySpot = fC.gradient.gradientStops[0].color.spot;
                break;
        }
