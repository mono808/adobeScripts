...
var rE = {
    ...
    print_full:     /\d{1,5}(wme|ang|cs|a)\d\d-0\d\d_[a-z0-9äüöß-]+_[a-z0-9äüöß-]+/i,
    jobNr:          /\d{1,5}(wme|ang|cs|a)\d\d-0\d\d/i,
    jobNrShort :    /\d{1,5}(wme|ang|cs|a)\d\d/i,
    jobNrVeryShort: /\d{1,5}(W|A|C)/i,
    job_design:     /\d{1,5}(wme|ang|cs|a)\d\d-0\d\d_[a-z0-9äüöß-]+/i,
    jobDesignOld :  /\d{1,5}(wme|ang|cs|a)\d\d-0\d\d\s\([a-z0-9äüöß-]+\)/i,
    job_:           /\d{1,5}(wme|ang|cs|a)\d\d-0\d\d_/i,
    doc :           /\d{1,5}(wme|ang|cs|a)\d\d-0\d\d_[a-z0-9äüö-]+_(ansicht|filmhuelle)/i,
